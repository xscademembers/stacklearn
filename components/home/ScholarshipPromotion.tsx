...
export type ScholarshipPromoCms = {
...
export default function ScholarshipPromotion({ content }: { content: ScholarshipPromoCms }) {
  return (
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center py-8">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8">
            ...
            <span className="text-accent-soft">{content.headingHighlight}</span>
          </h2>
