        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Link
              key={index}
              href={service.href}
              className="group p-6 bg-white border-2 border-gray-200 rounded-2xl hover:border-brand hover:shadow-2xl hover:shadow-brand/20 transition-all duration-300 hover-lift"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-brand transition-colors duration-300">
                    {service.title}
                  </h3>
                  <p className="text-slate-600 leading-relaxed">{service.description}</p>
                  <span className="inline-flex items-center gap-2 mt-4 text-brand font-semibold group-hover:gap-3 transition-all duration-300">
                    Learn More
