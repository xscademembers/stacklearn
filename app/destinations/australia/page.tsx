...
const universities = [
  { name: "University of Melbourne", info: "Top-ranked for Research & Innovation" },
  { name: "University of Sydney", info: "Excellent for Business & Engineering" },
  { name: "Australian National University", info: "Renowned for Research Programs" },
  { name: "University of Queensland", info: "Strong in Sciences & Medicine" },
  { name: "Monash University", info: "Top for Engineering & IT" },
  { name: "University of New South Wales", info: "Excellent for Engineering" },
];
    ...
    <div className="pb-0">
      ...
      <section className="relative h-96 text-white flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4 drop-shadow-lg">Study in Australia</h1>
          <p className="text-xl md:text-2xl mb-8 font-medium">High quality of life with post-study work visa up to 4 years.</p>
          <Link
            href="/contact"
