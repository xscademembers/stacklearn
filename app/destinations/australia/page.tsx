...
const universities = [
  { name: "University of Melbourne", info: "Top-ranked for Research & Innovation", initials: "UM", color: "bg-blue-800" },
  { name: "University of Sydney", info: "Excellent for Business & Engineering", initials: "US", color: "bg-blue-600" },
  { name: "Australian National University", info: "Renowned for Research Programs", initials: "ANU", color: "bg-yellow-600" },
  { name: "University of Queensland", info: "Strong in Sciences & Medicine", initials: "UQ", color: "bg-purple-600" },
  { name: "Monash University", info: "Top for Engineering & IT", initials: "MU", color: "bg-blue-700" },
  { name: "University of New South Wales", info: "Excellent for Engineering", initials: "UNSW", color: "bg-yellow-500" },
];

const courses = [
  { name: "Engineering", duration: "2-4 years", fee: "AUD $25,000-$40,000/year" },
  { name: "Computer Science", duration: "2-4 years", fee: "AUD $28,000-$45,000/year" },
  { name: "Business Administration", duration: "1.5-2 years", fee: "AUD $30,000-$50,000/year" },
  { name: "Healthcare & Nursing", duration: "2-3 years", fee: "AUD $25,000-$40,000/year" },
  { name: "Data Science", duration: "1.5-2 years", fee: "AUD $28,000-$45,000/year" },
];

const scholarships = [
  { name: "Australia Awards Scholarships", eligibility: "International students", amount: "Full funding", deadline: "April 2025" },
  { name: "Endeavour Postgraduate Scholarship", eligibility: "Master's/PhD students", amount: "Up to $272,500", deadline: "June 2025" },
];
    ...
    <div className="pb-0">
      ...
      <section className="relative h-[480px] text-white flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-8 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-lg">Study in Australia</h1>
          <p className="text-xl md:text-2xl mb-10 font-medium max-w-3xl mx-auto">High quality of life with post-study work visa up to 4 years.</p>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-6 md:px-8">
          <div className="grid md:grid-cols-4 gap-6 md:gap-8">
            {[
              { label: "Tuition Range", value: "AUD $20,000–$45,000/year" },
              { label: "Living Cost", value: "AUD $12,000–$18,000/year" },
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6 md:px-8">
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-12 text-center">
            Scholarships for <span className="gradient-text">Australia Students</span>
          </h2>
