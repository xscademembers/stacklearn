...
const universities = [
  { name: "University of Leeds", info: "Top-ranked for Business & Engineering" },
  { name: "University of Manchester", info: "Excellent for Research Programs" },
  { name: "University of Birmingham", info: "Strong in Engineering & Sciences" },
  { name: "King’s College London", info: "Renowned for Medicine & Law" },
  { name: "University of Edinburgh", info: "Top for Computer Science" },
  { name: "University of Bristol", info: "Excellent for Engineering" },
];
    ...
    <div className="pb-0">
      ...
      <section className="relative h-96 text-white flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4 drop-shadow-lg">Study in the United Kingdom</h1>
          <p className="text-xl md:text-2xl mb-8 font-medium">World-class education and post-study work opportunities.</p>
          <Link
            href="/contact"
